...
RUN pip install --pre xformers -i https://mirrors.aliyun.com/pypi/simple/
RUN pip install --pre triton -i https://mirrors.aliyun.com/pypi/simple/
RUN pip install numexpr -i https://mirrors.aliyun.com/pypi/simple/

RUN git clone https://ghproxy.com/https://github.com/Sun-Star2023/stable-diffusion-webui3.git /content/stable-diffusion-webui/
...
RUN git clone https://ghproxy.com/https://github.com/deforum-art/deforum-for-automatic1111-webui /content/stable-diffusion-webui/extensions/deforum-for-automatic1111-webui
RUN git clone https://ghproxy.com/https://github.com/AlUlkesh/stable-diffusion-webui-images-browser /content/stable-diffusion-webui/extensions/stable-diffusion-webui-images-browser
RUN git clone https://ghproxy.com/https://github.com/camenduru/stable-diffusion-webui-huggingface /content/stable-diffusion-webui/extensions/stable-diffusion-webui-huggingface
RUN git clone -b v2.0 https://ghproxy.com/https://github.com/camenduru/sd-civitai-browser /content/stable-diffusion-webui/extensions/sd-civitai-browser
RUN git clone https://ghproxy.com/https://github.com/kohya-ss/sd-webui-additional-networks /content/stable-diffusion-webui/extensions/sd-webui-additional-networks
RUN git clone https://ghproxy.com/https://github.com/Mikubill/sd-webui-controlnet /content/stable-diffusion-webui/extensions/sd-webui-controlnet
RUN git clone https://ghproxy.com/https://github.com/camenduru/openpose-editor /content/stable-diffusion-webui/extensions/openpose-editor
RUN git clone https://ghproxy.com/https://github.com/jexom/sd-webui-depth-lib /content/stable-diffusion-webui/extensions/sd-webui-depth-lib
RUN git clone https://ghproxy.com/https://github.com/hnmr293/posex /content/stable-diffusion-webui/extensions/posex
RUN git clone https://ghproxy.com/https://github.com/camenduru/sd-webui-tunnels /content/stable-diffusion-webui/extensions/sd-webui-tunnels
RUN git clone https://ghproxy.com/https://github.com/etherealxx/batchlinks-webui /content/stable-diffusion-webui/extensions/batchlinks-webui
...
CMD cd /content/stable-diffusion-webui && python webui.py --xformers --listen --enable-insecure-extension-access --gradio-queue --port 9000 ${CLI_ARGS}